...
export const GURU_RAW = [
  { id: 'g-001', nama: 'Ust. Salim',     kelasIds: ['tpq-1'], ttd: { x: 0,  y: 2,   scale: 100 } , color: '#0d9488' },
  { id: 'g-002', nama: 'Ust. Farid',     kelasIds: ['tpq-2'], ttd: { ...TTD_DEFAULT } , color: '#7c3aed' },
  { id: 'g-003', nama: 'Usth. Maryam',   kelasIds: ['tpq-3'], ttd: { x: -4, y: 0,   scale: 92  } , color: '#2563eb' },
  { id: 'g-004', nama: 'Ust. Zubair',    kelasIds: ['tpq-4'], ttd: { ...TTD_DEFAULT } , color: '#16a34a' },
  { id: 'g-005', nama: 'Usth. Halimah',  kelasIds: ['tpq-5'], ttd: { ...TTD_DEFAULT } , color: '#d4a056' },
  { id: 'g-006', nama: 'Ust. Anwar',     kelasIds: ['tpq-6'], ttd: { ...TTD_DEFAULT } , color: '#dc2626' },
  { id: 'g-007', nama: 'Ust. Hasan',     kelasIds: ['mdn-1'], ttd: { x: 3,  y: -2,  scale: 108 } , color: '#0891b2' },
  { id: 'g-008', nama: 'Ust. Husain',    kelasIds: ['mdn-2'], ttd: { ...TTD_DEFAULT } , color: '#9333ea' },
  { id: 'g-009', nama: 'Ust. Ali',       kelasIds: ['mdn-3'], ttd: { ...TTD_DEFAULT } , color: '#0d9488' },
];
...
export function normalizeGurus(list) {
  ...
  return list.map((g, i) => ({
    ...
    kelasIds: Array.isArray(g.kelasIds) ? g.kelasIds : [],
...
export function findWaliKelasGuru(gurus, kelas) {
  ...
  const byKelas = gurus.find(g => g.kelasIds?.includes(kelas.id));
