  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav">
        ...
        <Link href="/raport-v4" className={active('/raport-v4')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <rect x="4" y="4" width="7" height="7" rx="1"/>
            <rect x="13" y="4" width="7" height="7" rx="1"/>
            <rect x="4" y="13" width="7" height="7" rx="1"/>
            <path d="M13 13h3v3M20 16v4M16 20h1"/>
          </svg>
          Cetak Raport V4
        </Link>
        ...
        <Link href="/guru" className={active('/guru')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3 17c2.5-3 6-3 8.5 0"/>
            <path d="M13 15.5c2-3.5 4.5-6.5 7.5-9.5"/>
            <path d="M17 20h4"/>
          </svg>
          Guru &amp; TTD
          <span className="pill">{gurus.length}</span>
        </Link>
