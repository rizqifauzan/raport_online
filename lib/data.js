...
export const ROLES = [
  ...
  { id: 'operator',   label: 'Operator',   desc: 'Kelola santri, kelas, dan cetak raport' },
  { id: 'wali-kelas', label: 'Wali Kelas', desc: 'Input nilai & akhlaq untuk kelas yang diampu' },
  { id: 'ustadz',     label: 'Ustadz',     desc: 'Input nilai mata pelajaran yang diajar' },
];

export const USERS_RAW = [
  { id: 'u-001', nama: 'Ustadz Hamid',     username: 'hamid',    email: 'hamid@alhikmah.sch.id',    role: 'admin',      kelasId: '',       status: 'Aktif',    dibuat: '2025-07-01', color: '#0d9488' },
  { id: 'u-002', nama: 'Ust. Salim',       username: 'salim',    email: 'salim@alhikmah.sch.id',    role: 'wali-kelas', kelasId: 'tpq-1',  status: 'Aktif',    dibuat: '2025-07-04', color: '#2563eb' },
  { id: 'u-003', nama: 'Usth. Maryam',     username: 'maryam',   email: 'maryam@alhikmah.sch.id',   role: 'wali-kelas', kelasId: 'tpq-3',  status: 'Aktif',    dibuat: '2025-07-04', color: '#7c3aed' },
  { id: 'u-004', nama: 'Ust. Hasan',       username: 'hasan',    email: 'hasan@alhikmah.sch.id',    role: 'wali-kelas', kelasId: 'mdn-1',  status: 'Aktif',    dibuat: '2025-07-06', color: '#16a34a' },
  { id: 'u-005', nama: 'Ibu Fatimah',      username: 'fatimah',  email: 'fatimah@alhikmah.sch.id',  role: 'operator',   kelasId: '',       status: 'Aktif',    dibuat: '2025-07-10', color: '#d4a056' },
  { id: 'u-006', nama: 'Ust. Zubair',      username: 'zubair',   email: 'zubair@alhikmah.sch.id',   role: 'ustadz',     kelasId: 'tpq-4',  status: 'Nonaktif', dibuat: '2025-08-02', color: '#dc2626' },
];
